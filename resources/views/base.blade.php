            ...
            <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div class="flex items-center lg:order-2">
                        ...
                        @endif
                        <button @click="dark = !dark; localStorage.setItem('darkMode', dark ? 'enabled' : 'disabled')" class="hidden sm:inline-block p-1 dark:hover:bg-blue-800 hover:bg-blue-200 dark:hover:text-white rounded-full">
                        ...
                        <button data-collapse-toggle="mobile-menu-2" type="button" class="sm:inline-flex items-center p-2 ml-1 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-2" aria-expanded="false">
