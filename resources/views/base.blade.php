            ...
            <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <a href="{{ route('home') }}" class="flex items-center">
                        ...
                        <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">SnackSite</span>
                    </a>
                    ...
                    <div class="flex items-center lg:order-2">
                        ...
                        <button @click="dark = !dark; localStorage.setItem('darkMode', dark ? 'enabled' : 'disabled')" class="p-1 dark:hover:bg-blue-800 hover:bg-blue-200 dark:hover:text-white rounded-full">
