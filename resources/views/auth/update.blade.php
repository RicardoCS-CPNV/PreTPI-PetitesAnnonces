...
@section("content")
    <div class="flex flex-col items-center gap-4 min-h-screen justify-center">
        ...
        <div class="w-full max-w-max">
            <form method="POST" action="{{ route('auth.update') }}" enctype="multipart/form-data" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 w-max">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <div class="mb-3 col-md-6 flex justify-between items-center">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class=" text-sm ml-4 hover:text-blue-500 cursor-pointer">
                        <a href="">Mot de passe oublié ?</a>
                    </div>
                </div>
                <div class="mt-5 text-red-500 hover:text-red-900 cursor-pointer">
                    Supprimer le compte
                </div>
            </form>
        </div>
